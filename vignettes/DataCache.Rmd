...
```
                          file             created    age_mins
1 Cache2015-11-06 12:46:57.rda 2015-11-06 12:46:57 0.009265415
  hourly_stale daily_stale weekly_stale monthly_stale yearly_stale
...
```
[1] "cache.date1"     "cache.date2"     "cache.date3"     "loadWeatherData"
[5] "weather.ALB"    
```
...
```
Data is being loaded by another process. The process has been running for 0.629065990447998 seconds. If this is an error delete cache/Cache.lck
Loading more recent data, returning lastest available.
```
...
1 JFK2015-11-06 12:47:57.rda 2015-11-06 12:47:57 0.02451805        FALSE
